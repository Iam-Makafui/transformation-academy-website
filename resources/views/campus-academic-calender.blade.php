...
<!-- Page Title -->
@section('page_title')
   Academic Calendar - Transformation Academy
@endsection
<!-- /Page Title -->
...
<div class="kingster-breadcrumbs">
    <div class="kingster-breadcrumbs-container kingster-container">
        <div class="kingster-breadcrumbs-item kingster-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Kingster." href="/" class="home"><span property="name">Home</span></a>
            ...
            </span>&gt;<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Finance." href="/campus/calender" class="post post-page"><span property="name">Academic Calendar</span></a>
                    ...
                    <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                            <div class="gdlr-core-text-box-item-content" style="font-size: 18px ;text-transform: none ;color: #707070 ;">
                                <p>
                                    The following are the provisional term dates for the new academic year. We have included the instalment payment dates for parents/guardians who would like to pay fees by instalment.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <table style="min-width: 835px; width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;">
                                    <tbody>
                                        <tr style="background-color: #f2f2f2; color: #333; font-weight: bold;">
                                            <th style="padding: 10px; border: 1px solid #ddd; text-align: center; width: 20%;">DATE</th>
                                            <th style="padding: 10px; border: 1px solid #ddd; text-align: center; width: 30%;">DESCRIPTION</th>
                                            <th style="padding: 10px; border: 1px solid #ddd; text-align: center; width: 50%;">SECTION</th>
                                        </tr>
                                        <tr>
                                            <td style="padding: 10px; border: 1px solid #ddd; vertical-align: top;">Wednesday, 14th December</td>
