...
<!-- Page Title -->
@section('page_title')
   School Song(s) - Transformation Academy
@endsection
<!-- /Page Title -->
...
<div class="kingster-page-title-wrap  kingster-style-medium kingster-left-align">
    ...
    <div class="kingster-page-title-container kingster-container">
        <div class="kingster-page-title-content kingster-item-pdlr">
            <h1 class="kingster-page-title">SCHOOL SONGS</h1></div>
    </div>
</div>
<div class="kingster-breadcrumbs">
    <div class="kingster-breadcrumbs-container kingster-container">
        <div class="kingster-breadcrumbs-item kingster-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Kingster." href="/" class="home"><span property="name">Home</span></a>
            ...
            </span>&gt;<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Finance." href="/campus/calender" class="post post-page"><span property="name">School Songs</span></a>
